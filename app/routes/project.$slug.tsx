...
export default function ProjectDetailRoute() {
  ...
  return (
    <main className="min-h-screen space-y-10 overflow-x-clip bg-linear-to-br from-stone-100 via-neutral-50 to-stone-200 dark:from-slate-950 dark:to-slate-900">
